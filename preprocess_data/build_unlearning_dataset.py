...
def save_huggingace_dataset(global_name_twin_phone_list, global_category_twin_phone_list, global_twin_phone_template_list, global_twin_phone_template_type_list, global_twin_phone_template_target_list, global_twin_phone_target_pii_type_list,
    ...
    data_path = os.path.join(directory_path, "unlearning_phone_number_twin_phone_template_dataset")
    ...
    data_path = os.path.join(directory_path, "unlearning_address_twin_address_template_dataset")
...
if __name__ == '__main__':
    ...
    for person_index in range(len(privacy_ground_truth_table)):
        ...
        if (len(gt_PHONE_list) > 0):
            ...
            for index in range(len(gt_PHONE_list)):
                gt_PHONE = gt_PHONE_list[index]
                ...
                global_twin_phone_template_target_list.append(gt_PHONE)
        ...
        if (len(gt_ADDRESS_list) > 0):
            ...
            for index in range(len(gt_ADDRESS_list)):
                gt_ADDRESS = gt_ADDRESS_list[index]
                ...
                global_twin_address_template_target_list.append(gt_ADDRESS)
