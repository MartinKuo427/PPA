...
def save_huggingace_dataset(global_name_twin_email_list, global_category_twin_email_list, global_twin_email_template_list, 
    ...
    data_path = os.path.join(directory_path, "dummy_email_number_twin_email_template_dataset")
