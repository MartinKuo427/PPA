...
# save_propile_record_rank_to_excel(rank, global_name_list, global_category_list, global_template_type_list, global_template_input_list, global_template_output_list, global_aws_comprehend_output_list)
...
if __name__ == '__main__':
    ...
    config = PromptTuningConfig(
        ...
        prompt_tuning_init_text="address",
    ...
    for index in tqdm(range(start_data_point, end_data_point, 1)):
        ...
        with torch.no_grad():
            template_output_ids = model.generate(**model_input, max_new_tokens=pii_length, pad_token_id=tokenizer.pad_token_id, num_beams=3, num_return_sequences=1, early_stopping=True, max_time=600.0, use_cache=True)
